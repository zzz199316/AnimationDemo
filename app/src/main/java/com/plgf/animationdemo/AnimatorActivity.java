    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.imageView_b:
                Toast.makeText(AnimatorActivity.this, "b", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageView_c:
                Toast.makeText(AnimatorActivity.this, "c", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageView_d:
                Toast.makeText(AnimatorActivity.this, "d", Toast.LENGTH_SHORT).show();
                break;
            case R.id.imageView_e:
                Toast.makeText(AnimatorActivity.this, "e", Toast.LENGTH_SHORT).show();
                break;
        }
    }
